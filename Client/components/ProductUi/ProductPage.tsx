    ...
    switch (response.status) {
      case 200:
        ...
        if (response.data.data != undefined)
          totalQuantity.current = response.data.data.stock;
        setdataChecked(true);
        break;
      case 500:
        found.current = false;
              ...
              <>
                ...
                <div className="flex justify-center gap-10 flex-col items-center lg:flex-row">
                  <div className="flex img-wrapper flex-col gap-5 w-[90%] md:w-[60%] px-2 lg:w-[600px] lg:h-[600px] rounded-xl items-center">
                    <img
                      className="border-[1px] rounded-xl w-[100%] lg:w-[600px] lg:h-[600px] hover-zoom"
                  ...
                  <div className="flex flex-col gap-5 border-[1px] py-10 px-10 max-w-[90%] rounded-xl lg:max-w-[50%] w-auto">
                    <div className="border-b-[1px] pb-5 mb-2">
                      <p className="text-3xl max-w-[600px] font-medium">
                        {data.title}
                      </p>
...
{Number(data.discount || 0) > 0 && (
  <p className="text-yellow-500">
    {Number(data.discount)}% off
                    ...
                    <div className="flex flex-col gap-2 text-sm bg-gray-50 p-4 rounded-lg border">
                      {data.brand_name && (
                        <p>
                    ...
                    <div className="flex gap-10 items-center">
                      ...
                      <div className="flex items-center justify-center rounded-xl bg-gray-100">
                        <button
                          ...
                          className="w-[50px] text-4xl bg-gray-100 rounded-l-lg"
                        >
                          -
                        </button>
                        ...
                        <button
                          ...
                          className="w-[40px] text-4xl bg-gray-100 rounded-r-lg"
                        >
                          +
                        </button>
                      </div>
                    ...
                    <div className="flex gap-5">
                      <button
                        ...
                        className="w-[200px] h-[50px] bg-yellow-400 rounded-lg hover:border-yellow-400 hover:border-2 hover:bg-white transition-colors duration-300 font-semibold"
                      >
                        {btnLoading ? (
                      ...
                      <button
                        onClick={() =>
                          router.push(
                            `/checkout/${data.productid}/${selectedSize.sizeid}/${selectedColor.colorid}`,
                          )
                        }
                        className="w-[200px] h-[50px] rounded-lg font-semibold border-yellow-400 hover:bg-yellow-400 transition-colors duration-300 border-[2px]"
                      >
                        BUY NOW
                      </button>
                    </div>
                    <div className="flex gap-10 text-silver text-sm border-b-[1px] pb-10">
                      <button
                        ...
                        className="flex hover:text-yellow-400 transition-colors duration-300 items-center gap-1 cursor-pointer"
                      >
                        <HeartIcon width={25} />
                        <div>
                          {btnLoading ? (
