...
const CartCheckout = () => {
    ...
    const finalGiftMessage = giftOptions.gift_message.trim() !== ''
    ...
    async function createOrder(e:any){
        e.preventDefault();
        setloading(true);
        const createOrder = await cartCashCheckoutHandler({
    ...
    <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <form action="/" id='informational-form' onSubmit={createOrder} className="min-w-0 flex-1 space-y-8">
            ...
            <div className="space-y-4 p-4 border rounded-xl bg-pink-50">
                <h3 className="text-xl font-semibold text-gray-900">🎁 Gift Options</h3>
                <div className="flex items-center gap-3">
                    ...
                    />
                    <label htmlFor="gift_wrapping" className="text-sm font-medium">Add Gift Wrapping</label>
                </div>
                <div>
                    <label className="block mb-2 text-sm font-medium">Gift Wrap Style</label>
                    <select
                ...
                <div>
                    <label className="block mb-2 text-sm font-medium">Gift Card Template</label>
                    <select
                    ...
                    >
                        ...
                        <option value="Wishing you joy and creativity!">Wishing you joy and creativity!</option>
                ...
                <div>
                    <label className="block mb-2 text-sm font-medium">Personal Message</label>
                    <textarea
                        name="gift_message"
                        rows={4}
                        maxLength={300}
