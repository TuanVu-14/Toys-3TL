...
const Checkout = () => {
  ...
  async function sync() {
    ...
    if (sessionCheck?.success && userDataCheck?.success) {
      ...
      if (sessionCheck.data != undefined)
        genUserData.current = sessionCheck.data;
      if (
        userDataCheck.addresses != undefined &&
        userDataCheck.addresses.length > 0
      )
        userDataCheck.addresses.map((each) => {
  ...
  return (
    <section className="bg-white py-8 h-screen w-screen overflow-x-hidden antialiased relative dark:bg-gray-900 md:py-6">
      <Dialog
        open={dialogType === "addressRequired"}
        onClose={() => setdialogType("addressRequired")}
      ...
      >
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          <DialogPanel className="max-w-lg space-y-4 border bg-white p-12 rounded-xl text-center drop-shadow-custom-xl">
            ...
            <Description>
              Please add a Address to Proceed with Checkout
            </Description>
      ...
      <Dialog
        open={dialogType === "defaultAddressRequired"}
        onClose={() => setdialogType("defaultAddressRequired")}
        className="relative z-50"
      >
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          <DialogPanel className="max-w-lg space-y-4 border bg-white p-12 rounded-xl text-center drop-shadow-custom-xl">
            ...
            <Description>
              Please add a Default Address or Set Existing Address to Default to
      ...
      {loading && (
        <div className="w-screen h-screen absolute">
          {loading && (
            <div className="absolute left-0 right-0 top-[30%] z-50">
              <Loading />
            </div>
          )}
        </div>
      ...
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
          ...
          >
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    disabled={true}
                    value={genUserData.current.userName}
                    type="text"
                    id="your_name"
                ...
                <div>
                  ...
                  <input
                    disabled={true}
                    value={genUserData.current.email}
                    type="email"
                    id="your_email"
                    className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                ...
                <div>
                  ...
                  <input
                    disabled={true}
                    value={genUserAddress.current.country}
                    type="text"
                    placeholder="India"
                ...
                <div>
                  ...
                  <input
                    disabled={true}
                    value={genUserAddress.current.city}
                    type="text"
                    placeholder="Delhi"
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="relative w-full">
                      <input
                        disabled={true}
                        value={genUserData.current.mobile_number}
                        type="text"
                        maxLength={10}
                        minLength={10}
                        id="phone-input"
                ...
                <div>
                  ...
                  <input
                    disabled={true}
                    value={genUserAddress.current.postalCode}
                    type="number"
                    minLength={6}
                    maxLength={10}
                    id="pincode"
                ...
                <div>
                  ...
                  <input
                    disabled={true}
                    value={genUserAddress.current.addressLine1}
                    type="text"
                    id="address1"
                    className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                ...
                <div>
                  ...
                  <input
                    disabled={true}
                    value={genUserAddress.current.addressLine2}
                    type="text"
                    id="address2"
                    className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
            ...
            <div className="p-4 mb-8 flex flex-col gap-4">
              <div className="flex border-[1px] min-h-[150px] rounded-xl px-6 py-6 items-center mb-4">
                <img
                  ...
                  width={100}
                  height={100}
                  className="mr-10 bg-gray-50 rounded-xl"
                />
                <div className="flex flex-col gap-5 sm:gap-0 sm:flex-row justify-between w-full items-center">
                  <div
                    className={`flex flex-col ${data.sizename != null || data.colorname != null ? "gap-1" : "gap-5"}`}
                  >
                    <h4 className="font-medium text-xl">{data.title}</h4>
                    {data.sizename != null && (
                      <p className="text-sm font-medium">
                        Size:{" "}
                        <span className="font-semibold">{data.sizename}</span>
                      </p>
                    )}
                    {data.colorname != null && (
                      <p className="text-sm font-medium">
                        Color:{" "}
                        <span className="font-semibold">{data.colorname}</span>
                      </p>
                    )}
            ...
            <div className="space-y-4 p-4 border rounded-xl bg-pink-50">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="gift_wrapping" className="text-sm font-medium">
                  Add Gift Wrapping
                </label>
              </div>
              ...
              <div>
                ...
                <select
                  name="gift_wrap_style"
                  className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm"
                  value={giftOptions.gift_wrap_style}
                  onChange={(e) =>
                    setGiftOptions({
                      ...giftOptions,
                      gift_wrap_style: e.target.value,
                    })
                  }
                >
              ...
              <div>
                ...
                <select
                  name="gift_message_template"
                  className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm"
                  value={giftOptions.gift_message_template}
                  onChange={(e) =>
                    setGiftOptions({
                      ...giftOptions,
                      gift_message_template: e.target.value,
                    })
                  }
                >
                  <option value="">Select a message template</option>
                  <option value="Happy Birthday!">Happy Birthday!</option>
                  <option value="Wishing you joy and creativity!">
                    Wishing you joy and creativity!
                  </option>
                  <option value="A special gift just for you!">
