    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center">
                ...
                <p className="mb-4 text-2xl tracking-tight font-bold text-gray-900 md:text-3xl dark:text-white">Chúng tôi đang cập nhật thêm sản phẩm vào danh mục. Bạn có thể xem các danh mục khác hoặc quay về trang chủ.</p>
