                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={e=>register(e,appState.agreement,updates)} className="space-y-4 md:space-y-6 flex flex-col gap-4 lg:gap-0">
                                ...
                                <div>
                                    ...
                                    <input required type="tel" minLength={10} maxLength={10} pattern="\d{10}" inputMode='numeric' name="mobilenum" id="mobilenum" placeholder="Nhập số điện thoại" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"/>
                                </div>
                                <div>
                                ...
                                <div className="flex flex-col gap-4 justify-between">
                                    <div className="flex items-start">
                                        ...
                                        <div onClick={()=>toggleAgreement()} className="ml-3 text-sm font-medium">
                                            <label className="text-gray-500">Khi đăng ký, bạn đang tạo tài khoản 3TL-Shop và đồng ý với <a className='text-primary-700 font-medium' href='/policy/terms&conditions'>Điều khoản & điều kiện</a> và <a className='text-primary-700 font-medium' href='/policy/privacypolicy'>Chính sách bảo mật.</a></label>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="flex items-center h-5">
                                ...
                                <p className="text-sm font-light text-gray-500">
                                    Bạn đã có tài khoản? <Link href="/sign-in" className="font-medium text-primary-600 hover:underline">Đăng nhập</Link>
                                </p>
                            </form>
                        </div>
                    </div>
