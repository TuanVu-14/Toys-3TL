    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center">
                ...
                <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Xin lỗi, bạn cần đăng nhập để xem chi tiết đơn hàng. Bạn vẫn có thể khám phá trang chủ hoặc đăng nhập ngay để xem đơn hàng.</p>
