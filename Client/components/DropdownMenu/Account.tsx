  ...
  return (
    ...
    >
      ...
      {isDropdownVisible && appState.loggedIn && (
        <div
          id="dropdownAvatar"
          className="z-30 bg-white divide-y divide-gray-100 rounded-lg absolute drop-shadow-custom-xl w-44"
        >
          ...
          <div className="py-2">
            <button
              onClick={signOut}
              className="block px-4 w-full text-start py-2 text-sm text-gray-400 hover:bg-gray-100"
            >
              Sign out
            </button>
          </div>
